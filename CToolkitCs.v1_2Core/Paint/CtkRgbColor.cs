...
namespace CToolkitCs.v1_2Core.Paint
{
    public class CtkRgbColor
    {
        ...
        public CtkRgbColor(Color value)
        {
            this.R = value.R;
            this.G = value.G;
            this.B = value.B;
        ...
        public static implicit operator Color(CtkRgbColor rgb)
        {
            Color c = Color.FromArgb(rgb.A, rgb.R, rgb.G, rgb.B);
            return c;
        }
        public static explicit operator CtkRgbColor(Color c)
        {
            return new CtkRgbColor(c);
        }


        // Given H,S,L in range of 0-1
        // Returns a Color (RGB struct) in range of 0-255
        public static CtkRgbColor FromHSL(double H, double S, double L)
        {
        ...
        // Returns a Color (RGB struct) in range of 0-255
        public static CtkRgbColor FromHSLA(double H, double S, double L, double A)
        {
            double v;
            double r, g, b;
            if (A > 1.0)
            ...
            CtkRgbColor rgb = new CtkRgbColor();
